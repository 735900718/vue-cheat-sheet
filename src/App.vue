...
.menu-root > .Global {background-color: #C594C5;}

.menu-root > .Options {background-color: #F99157; }

.menu-root > .Methods {background-color: #5FB3B3}
.menu-root > .Instance {background-color: #6699CC}
.menu-root > .html {background-color: #EC5f67}
.menu-root > .指令 {background-color: #8D89D1}
.menu-root > .内置 {background-color: #EAB853}
.menu-root > .Modifiers {background-color: #AB7967}

.menu-root > li {
  background-color: #89B784;
  padding: 10px;
  width: 100%;
  margin-bottom: 5px;
  border-radius: 10px;
